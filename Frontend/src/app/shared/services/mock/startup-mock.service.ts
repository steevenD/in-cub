    ...
    for(let i = 0; i < 30; i++) {
      if (i % 2 === 0) {
        const startupWithAdress: Startup = new Startup(i, faker.company.companyName(), faker.commerce.department(),
          faker.finance.accountName(), faker.random.number(), faker.company.catchPhraseDescriptor(),
        ...
        faker.finance.accountName(), faker.random.number(), faker.company.catchPhraseDescriptor(), null,
